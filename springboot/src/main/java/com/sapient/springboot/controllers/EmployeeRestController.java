package com.sapient.springboot.controllers;
...
import com.sapient.springboot.repos.EmployeeJpaRepo;
...
//	public Employee Employee(@RequestParam("id") int id, @RequestParam("salary") double salary){
//		
//		
//		Employee emp = employeeJpaRepo.getOne(id);
